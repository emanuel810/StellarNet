    ...
    <section className="banner" id="home">
      <Container>
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            <h1>{`¡La mejor señal de todo el`} <span className="txt-rotate" dataPeriod="1000" data-rotate='[ "planeta!", "sistema solar!", "Universo!" ]'><span className="wrap">{text}</span></span></h1>
